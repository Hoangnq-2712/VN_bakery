...
<div class="panel panel-primary" style="margin:0px 10px;margin-top: 20px;">
	...
	<div class="panel-body">
		...
		<form action="{{route('them-tin-tuc')}}" method="POST" role="form" enctype="multipart/form-data">
			{!! csrf_field() !!}
			<div class="container">
				<div class="row">
					...
					<div class="col-md-11">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="creator" placeholder="Nhập tên tác giả" >
